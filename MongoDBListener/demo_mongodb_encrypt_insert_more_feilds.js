...
MongoClient.connect(url, function(err, db) {
  ...
  var myobj = { 
		...
		startDate: CryptoJS.AES.encrypt("11:47 Tuesday, 11 June 2019 (BST)",'9ZQsIE2mLQ5a').toString(),
		endDate: CryptoJS.AES.encrypt("15/06/2019",'9ZQsIE2mLQ5a').toString(),
		intake: CryptoJS.AES.encrypt("Intake 647",'9ZQsIE2mLQ5a').toString(),
		tech: CryptoJS.AES.encrypt("Java",'9ZQsIE2mLQ5a').toString(),
		emailbusiness: CryptoJS.AES.encrypt("JohnSmith@QA.com",'9ZQsIE2mLQ5a').toString(), 
		...
		securityClearance: CryptoJS.AES.encrypt("BPSS",'9ZQsIE2mLQ5a').toString(), 
		statusinfo : CryptoJS.AES.encrypt("Bench",'9ZQsIE2mLQ5a').toString()
		};	
		console.log(myobj);
